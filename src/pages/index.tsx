...
export default function Home({ posts: originalPosts }: IHomeProps) {
  ...
  return (
    <div>
      ...
      <div
        className="w-4/5 m-auto bg-white mt-[-42px] rounded-tl-[1.875rem] min-h-[21.5rem] p-6 md:p-14 flex flex-wrap-reverse justify-around cursor-pointer"
      ...
      >
        ...
        <div className="w-[35.625rem] max-h-80">
          <img
            ...
            alt={highlightPost.fields.title}
